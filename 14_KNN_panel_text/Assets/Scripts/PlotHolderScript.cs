...
public class PlotHolderScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Debug.Log("plotPosition: " + plotPosition.ToString());

        //Vector3 dataPointPosition = new Vector3((float) 0.2, (float)0.5, 0) + plotPosition;
        //Debug.Log("dataPointPosition: " + dataPointPosition.ToString());


        //Quaternion plotRotation = gameObject.transform.rotation;
        //Debug.Log("plotRotation: " + plotRotation.ToString());



        //var maleDatapoint2 = Instantiate(maleDatapointObject, dataPointPosition, plotRotation);
        //maleDatapoint2.transform.parent = gameObject.transform;
    ...
    public void handleQrCode(string qrCodeData)
    {
        ...
        {
            //var datapointInstance = Instantiate(maleDatapointObject, new Vector3((float)0.4, (float)0.4, 2), Quaternion.identity);
            //datapointInstance.transform.parent = gameObject.transform;
            ...
            dataPointList.Add(maleDatapoint2);
        ...
        {
            var datapointInstance = Instantiate(femaleDatapointObject, new Vector3((float)0.2, (float)0.35, 2), Quaternion.identity);
            datapointInstance.transform.parent = gameObject.transform;
        ...
        {
            //var datapointInstance = Instantiate(maleDatapointObject, new Vector3((float)0.2, (float)0.45, 2), Quaternion.identity);
            //datapointInstance.transform.parent = gameObject.transform;
        ...
        {
            var datapointInstance = Instantiate(femaleDatapointObject, new Vector3((float)0.2, (float)0.40, 2), Quaternion.identity);
            datapointInstance.transform.parent = gameObject.transform;
