...
namespace QRTracking
{
    public class QRCodesVisualizer : MonoBehaviour
    {
        ...
        public TextMesh LatestQRCodeDetails;
        ...
        void Start()
        {
            ...
            // subscribe method "Instance_QRCodeRemoved" to "QRCodesManager.Instance.QRCodeRemoved"
            // when event "QRCodesManager.Instance.QRCodeRemoved" is raised, the method "Instance_QRCodeRemoved" is called
